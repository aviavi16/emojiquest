	...
	public class SVGTextContentElement:SVGGraphicsElement{
		...
		public override bool OnAttributeChange(string property){
			...
			if(property=="x"){
				...
				X=Css.Value.Load(this["x"]).ToSet();
				
			}else if(property=="y"){
				
				Y=Css.Value.Load(this["y"]).ToSet();
				
			}else if(property=="dx"){
				
				Dx=Css.Value.Load(this["dx"]).ToSet();
				
			}else if(property=="dy"){
				
				Dy=Css.Value.Load(this["dy"]).ToSet();
				...
				TextLength=Css.Value.Load(this["textlength"]);
				
			}else if(property=="lengthadjust"){
				
				LengthAdjust=Css.Value.Load(this["lengthadjust"]);
